...
from ai.prompt_templates import STYLE_SYSTEM_PROMPTS, SCRIPT_PROMPT
...
def generate_script(story: dict, style: str = None) -> dict:
    """
    Generate full script package for a story.
    Returns enriched story dict with narration, scenes, shorts, title variants.
    """

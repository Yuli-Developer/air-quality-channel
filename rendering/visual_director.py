...
def _build_prompt(scene: dict, characters: str, shot_type: str) -> str:
...
def generate_scene_image(scene: dict, run_id: str, characters: str = "",
                          width: int = 1792, height: int = 1024) -> str:
    ...
    prompt    = _build_prompt(scene, characters, shot_type)
    seed      = scene_num * 42
...
def generate_all_images(story: dict, run_id: str,
    ...
    for scene in story["scenes"]:
        path = generate_scene_image(scene, run_id, characters, width, height)
